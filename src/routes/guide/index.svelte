...
<div class="container mx-auto sm:justify-between mt-10 md:mt-20">
  <div class="mx-auto">
    <h2 class="mb-10">Amortize User Guide</h2>
      ...
      <div class="guide-content">
        <div class="toc boxShadow">
          ...
          <ol style="list-style: decimal; padding-left: 30px">
            ...
            <li>
              <p>
                <a href="#upload-property-and-mint-nft"
                  >UPLOAD PROPERTY & MINT NFT</a
                >
              </p>
            </li>
            <li>
              <p><a href="#list-property">LIST PROPERTY</a></p>
              <ol style="list-style: decimal; padding-left: 30px">
            ...
            <li>
              ...
              <ol style="list-style: decimal; padding-left: 30px">
                <li><a href="#edit-profile">Edit your Amortize profile</a></li>
              </ol>
            </li>
          </ol>
        </div>
        <div class="guide">
          ...
          <div class="item" id="fund-your-wallet">
            ...
            <p>
              Agents will need a bit of Liquid Bitcoin (L-BTC) in their wallet
              to mint an NFT (~0.000013 L-BTC or ~0.5 USD at the time of
              writing). Amortize users will also need L-BTC or other Liquid
              assets (e.g. USDt Liquid) in their wallets to bid on property.
              Your wallet can be funded through a Liquid, Bitcoin on-chain or
            ...
            <p class="font-bold">
              ...
              to L-BTC within Amortize. This is probably the most
              straightforward and easiest way to get L-BTC in your Amortize
              wallet.
            </p>
            <p>
          ...
          <div class="item" id="liquid">
            ...
            <p>
              When selecting “Fund” in your Amortize wallet, you will be shown a
              ...
              including L-BTC, USDt (Liquid), or L-CAD directly to your Amortize
            ...
            <p>
              ...
              Liquid assets to your Amortize wallet. If you get an error in your
            ...
            <p>
              To speed up your Amortize wallet funding process, avoid funding
          ...
          <div class="item" id="btc-lightning">
            ...
            <p>
              You can also fund your Amortize Liquid wallet using Lightning. By
              ...
              L-BTC that will then be deposited in your Amortize Liquid wallet.
          ...
          <div class="item" id="upload-property-and-mint-nft">
            <h3>4. UPLOAD PROPERTY & MINT NFT</h3>
            <p>
              All new accounts in Amortize are “Fan” accounts. With this type of
              ...
              reserved for users with an agent account. Agents will get their
              accounts tagged as “Agents” during the onboarding process.
            </p>
            <p>
            ...
            <p>
              ...
              as the username of the agent that created the property, the
              current owner (in this case the same agent), and under asset
            ...
            <p>
              ...
              “Unlisted” so no other Amortize user can see it in the platform.
          ...
          <div class="item" id="list-property">
            ...
            <p>
              1. Go to your Amortize profile page. There, you will find all your
          ...
          <div class="item" id="simple-listing">
            ...
            <p>
              ...
              agent in subsequent sales of the NFT. Setting a royalty involves
              transferring the property to a 2-of-2 multisig address with
              Amortize. Our servers will only co-sign a transfer if they pay the
              specified royalty to the original agent. This percentage can not
              be modified afterwards by any NFT owner. Once an NFT has a royalty
              associated it gets locked in Amortize to ensure that the original
              agents receive their royalties, which means the NFT cannot be
              transferred outside of the platform. If you want your NFT to be
              transferable outside of Amortize wallets, do not add a royalty.
            </p>
            <p>
          ...
          <div class="item" id="auction">
            ...
            <p>
              ...
              address. The Amortize server will co-sign this transaction once
              the auction is finished and the NFT will be sent to the highest
              bidder and the money to the agent.
            </p>
            <p>
          ...
          <div class="item" id="what-to-expect-after-listing">
            ...
            <p>
              After listing your property, Amortize users will be able to bid in
              ...
              offers in the property page and in your profile page under
              “Offers.” If you did a simple listing (i.e., not auction) after
              someone places a bid on your property, you can accept that offer,
            ...
            <p>
              ...
              deposit the bid money into your Amortize wallet. Your property
              will still be visible to you in your profile page under
              “Creations” but since you no longer are the owner, it won’t show
              up under the “Collection” tab. The property page will also show
              the history of the NFT and it will reflect the new owner.
            </p>
            <img
              class="guide-image"
            ...
            />
            <p>
              If you decide to list your property as an auction, Amortize users
              ...
              Amortize users will also see a countdown timer indicating when the
          ...
          <div class="item" id="edit-profile">
            <h4>7.1 Edit your Amortize profile</h4>
